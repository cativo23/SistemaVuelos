                ...
                <div class="block">
                    ...
                    <div class="block-content">
                        ...
                        <form action="{{ route('admin-airline.update', $airline->id)}}" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 @if($errors->has('codigo')) is-invalid @endif">
                                    <div class="form-material floating input-group">
                                        <input type="text" class="form-control" id="codigo" value="{{ old('codigo', isset($airline) ? $airline->code : '') }}" name="codigo">
                                ...
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="nombrecorto" value="{{ old('nombrecorto', isset($airline) ? $airline->short_name : '') }}" name="nombrecorto">
                            ...
                            <div class="col-md-4  @if($errors->has('nombreoficial')) is-invalid @endif">
                                <div class="form-material floating input-group">
                                    <input type="text" class="form-control" id="nombreoficial" value="{{ old('nombreoficial', isset($airline) ? $airline->official_name : '') }}" name="nombreoficial">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 @if($errors->has('paisorigen')) is-invalid @endif">
                            <div class="form-material floating input-group">
                                <input type="text" class="form-control" id="paisorigen" value="{{ old('paisorigen', isset($airline) ? $airline->origin_country : '') }}" name="paisorigen">
                        ...
                        <div class="col-md-4 @if($errors->has('representante')) is-invalid @endif">
                            <div class="form-material floating input-group">
                                <input type="text" class="form-control" id="representante" value="{{ old('representante', isset($airline) ? $airline->representative : '') }}" name="representante">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 @if($errors->has('paginaweb')) is-invalid @endif">
                            <div class="form-material input-group">
                                ...
                                <input type="text" class="form-control" id="paginaweb" value="{{ old('paginaweb', isset($airline) ? $airline->web_page : '') }}" name="paginaweb">
