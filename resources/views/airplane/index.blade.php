            ...
            <div class="row invisible" data-toggle="appear">
                ...
                <div class="block col-md-12">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Listado de Aviones</h3>
                        <a class="btn btn-success" href="{{ route("airplanes.create") }}">Agregar Avión</a>
                    </div>
                            ...
                            @foreach( $airplanes as $airplane)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('airplanes.show', $airplane->id) }}" type="button" class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip" title="Ver" data-original-title="Ver">
                                                <i class="fa fa-eye"></i>
                                            </a>
...
@section('js_after')
    ...
    <script>
        function deleteData(id, airplane_name)
        {
            ...
            let id_n = id;
            var url = '{{ route("airplanes.destroy", ":id") }}';
