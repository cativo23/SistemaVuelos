            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-50 pb-20">
                    <h1 class="font-w700 text-white mb-10 invisible" data-toggle="appear"
                        data-class="animated fadeInUp">Editar Aeropuerto</h1>
                                                ...
                                                <div class="form-material floating input-group">
                                                    <input type="text" class="form-control" id="telefono" name="telefono"
                                                           @foreach ($errors->all() as $error)
                                                                value="{{ old('telefono') }}"
                                                           @endforeach
                                                           value="{{$Airport->telephone}}" data-mask="(000) 0000 0000">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex align-items-center">
                                                ...
                                                @error('terminales') <div class="form-group input-group is-invalid"> @enderror
                                                    ...
                                                    @error('terminales')<div id="terminales-error" class="invalid-feedback animated fadeInDown">{{ $message }}</div>@enderror
