    ...
    <div class="bg-primary-darker text-body-color-light">
        <div class="content content-top">
                ...
                <div class="col-6 col-xl-3">
                    <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-right" href="javascript:void(0)">
                        <div class="block-content block-content-full clearfix">
                            ...
                            <div class="font-size-sm font-w600 text-uppercase text-muted">Dashboard Client</div>
                        </div>
                    </a>
                </div>
                <div class="col-6 col-xl-3">
            ...
            <div class="row invisible" data-toggle="appear">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_pages_generic_profile.html">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_pages_generic_search.html">
                        <div class="block-content">
                            <p class="mt-5">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_comp_charts.html">
                        <div class="block-content">
                            <p class="mt-5">
