            ...
            <div class="content-side content-side-full">
                <ul class="nav-main">
                    ...
                    <li class="nav-main-heading">
                        <span class="sidebar-mini-visible">BY</span><span class="sidebar-mini-hidden">Comprar</span>
                    </li>
                    <li>
                        <a href="{{route('buy')}}">
                            <i class="si si-globe"></i><span class="sidebar-mini-hide">Comprar Boletos</span>
                        </a>
                    </li>
                </ul>
            </div>
