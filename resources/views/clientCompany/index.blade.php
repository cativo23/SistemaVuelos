...
@section('section', 'Clientes Empresa')
            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-50 pb-20">
                    ...
                    <h2 class="h4 font-w400 text-white-op invisible" data-toggle="appear"
                        data-class="animated fadeInUp">Empresa</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row invisible" data-toggle="appear">
                ...
                <div class="block col-md-12">
                    <div class="block-header block-header-default">
                        ...
                        <a class="btn btn-success" href="{{ route("clientCompanys.create") }}">Agregar Clientes</a>
                    </div>
                            ...
                            @foreach($clientes_c as $cliente)
                                <tr data-entry-id="{{$cliente->client->id}}">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('clientCompanys.show', $cliente->client->id) }}" type="button"
                                               class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip"
                                               title="Ver" data-original-title="Ver">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('clientCompanys.edit', $cliente->client->id) }}" type="button"
                                               class="btn btn-sm btn-secondary js-tooltip-enabled" data-toggle="tooltip"
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Desea borrar el Cliente Empresa: </p>
                            <p id="clientCompany_name"></p>
...
@section('js_after')
    ...
    <script>
        function deleteData(id, clientCompany_name) {
            console.log(clientCompany_name);
            let id_n = id;
            var url = '{{ route("clientCompanys.destroy", ":id") }}';
            url = url.replace(':id', id_n);
            $("#deleteForm").attr('action', url);
            $('#clientCompany_name').append(clientCompany_name);
        }
