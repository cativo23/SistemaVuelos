                                        ...
                                        <div class="form-group row justify-content-center">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-material floating input-group">
                                                    <input type="text" class="js-flatpickr form-control departure_time"
                                                           name="departure_time[]" data-allow-input="true"
                                                           data-enable-time="true" data-no-calendar="true"
                                                           data-date-format="H:i" time_24hr="true">
                                            ...
                                            <div class="col-md-3">
                                                <div
                                                    class="form-material floating input-group ">
                                                    <input type="text"
                                                           class="js-flatpickr form-control arrival_time"
                                                           name="arrival_time[]" data-allow-input="true"
                                                           data-enable-time="true" data-no-calendar="true"
                                                           data-date-format="H:i" time_24hr="true">
    ...
    <script>
        ...
        jQuery(function () {
            ...
            function initNew(element) {
                ...
                let flat3 = document.querySelector(".arrival_time_new");
                let fp2 = flatpickr(flat3, {enableTime: true, noCalendar: true, dateFormat: "H:i",});
                let flat4 = document.querySelector(".departure_time_new");
                let fp3 = flatpickr(flat4, {enableTime: true, noCalendar: true, dateFormat: "H:i",});
