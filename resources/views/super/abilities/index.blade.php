            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-50 pb-20">
                    <h1 class="font-w700 text-white mb-10 invisible" data-toggle="appear"
                        data-class="animated fadeInUp">Permisos</h1>
                    <h2 class="h4 font-w400 text-white-op invisible" data-toggle="appear"
                        data-class="animated fadeInUp">Administre Permisos</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row invisible" data-toggle="appear">
                ...
                <div class="block col-12">
                    <div class="block-header block-header-default">
                        ...
                        <a class="btn btn-success" href="{{ route("super.abilities.create") }}">Agregar Permiso</a>
                    </div>
                    <div class="block-content block-content-full">
                        <!-- DataTables init on table by adding .js-dataTable-full class, functionality is initialized in js/pages/tables_datatables.js -->
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full datatable-Role">
                            <thead>
                            <tr>
                                <th></th>
                                <th class="text-center" style="width: 80px;">#</th>
                                <th style="width: 150px;">Nombre</th>
                                <th class="text-center" style="width: 50%;">Titulo</th>
                                <th>Acciones</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($abilities as $key => $ability)
                                <tr data-entry-id="{{ $ability->id }}">
                                    <td></td>
                                    <td class="text-center">{{ $ability->id ?? '' }}</td>
                                    <td class="font-w600">
                                        <a href="{{ route('super.abilities.show', $ability->id) }}">{{ $ability->name ?? '' }}</a>
                                    </td>
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Eliminar Permiso</h3>
                        ...
                        <div class="block-content">
                            <p>Desea borrar el permiso: <span id="role_name"></span>?</p>
...
@section('js_after')
    ...
    <script>
        function deleteData(id, role_name)
        {
            ...
            $('#role_name').replaceWith(role_name);
        }
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('super.abilities.mass') }}",
