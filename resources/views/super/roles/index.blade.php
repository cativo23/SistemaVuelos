            ...
            <div class="content content-top text-center overflow-hidden">
                <div class="pt-50 pb-20">
                    ...
                    <h2 class="h4 font-w400 text-white-op invisible" data-toggle="appear"
                        data-class="animated fadeInUp">Administre Roles</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row invisible" data-toggle="appear">
                ...
                <div class="block col-12">
                    <div class="block-header block-header-default">
                        ...
                        <a class="btn btn-success" href="{{ route("super.roles.create") }}">Agregar Rol</a>
                    </div>
                    <div class="block-content block-content-full">
                        ...
                        <table class="table table-bordered table-striped table-vcenter js-dataTable-full datatable-Role">
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="width: 50%;">Permisos</th>
                                <th>Acciones</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($roles as $key => $role)
                                <tr data-entry-id="{{ $role->id }}">
                                    ...
                                    <td class="font-w600">
                                        <a href="{{ route('super.roles.show', $role->id) }}">{{ $role->name ?? '' }}</a>
                                    </td>
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Eliminar Rol</h3>
